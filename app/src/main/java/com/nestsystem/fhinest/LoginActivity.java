...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView = findViewById(R.id.webview_login_akun);
        webView.setWebViewClient(new WebViewClient());
        webView.loadUrl("https://member.foreverhealthyindonesia.com/member/Login.aspx");
        ...
        BottomNavigationView bottomNavigationView = findViewById(R.id.bottom_login);
