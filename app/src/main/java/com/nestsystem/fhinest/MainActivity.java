...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView = findViewById(R.id.webview_beranda_fhi);
        webView.setWebViewClient(new WebViewClient());
        webView.loadUrl("https://apps.nestsystem.net/home-fhi-apps/");
        ...
        BottomNavigationView bottomNavigationView = findViewById(R.id.bottom_berandafhi);
        bottomNavigationView.setSelectedItemId(R.id.item_beranda_fhi);
