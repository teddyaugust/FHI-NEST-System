...
public class BerandaNEWSActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_beranda_newsactivity);

        webView = findViewById(R.id.webview_beranda_news);
        webView.setWebViewClient(new WebViewClient());
        webView.loadUrl("https://apps.nestsystem.net/home-news-apps/");
        ...
        BottomNavigationView bottomNavigationView = findViewById(R.id.bottom_berandanews);
        bottomNavigationView.setSelectedItemId(R.id.item_beranda_news);
